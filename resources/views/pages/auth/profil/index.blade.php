    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                <h2 class="section-title">Laurensius!</h2>
                <p class="section-lead">
                    my instagram: laurens_rez
                </p>
                    ...
                    <div class="col-12 col-md-12 col-lg-5">
                        <div class="card profile-widget">
                            <div class="profile-widget-header">
                                <img alt="image"
                                    src="{{ asset('img/avatar/alpin.jpg') }}"
                            ...
                            <div class="profile-widget-description">
                                <div class="profile-widget-name">Laurensius <div
                                        class="text-muted d-inline font-weight-normal">
                                        <div class="slash"></div> proflayer gaming
                                    </div>
                                </div>
                                Laurensius is a proflayer gaming name in <b>Indonesia</b>,
                                He is someone who is generous and kind, also saves diligently and many say is also handsome
                                <b>'pak ape'</b>.
                            </div>
                            <div class="card-footer text-center">
                                <div class="font-weight-bold mb-2">Follow Laurensius On your sosmed</div>
                                <a href="#"
